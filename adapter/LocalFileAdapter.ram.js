export default {
    ...
    "configSchema": {
        "type": "object",
        "properties": {
            "rootPath": { "type": "string", "description": "File path to root of all tenant-prefixed file storage" },
            "basePath": { "type": "string", "description": "Path below the tenant storage root for this service (generally unique)" },
