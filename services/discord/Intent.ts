export type Intent = "GUILDS" | "GUILD_MEMBERS" | "GUILD_BANS" | "GUILD_EMOJIS_AND_STICKERS" |
...
export const intentsNumber = (intents: Intent[]) => {
	const intentValues: Record<Intent, number> = {
		"GUILDS": 1 << 0,
		"GUILD_MEMBERS": 1 << 1,
		"GUILD_BANS": 1 << 2,
